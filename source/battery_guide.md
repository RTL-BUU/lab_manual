...
$$Time = \frac{E_{batt}}{Power} = \frac{360\text{Wh}}{50\text{W}} = 7.2\text{ ชั่วโมง}$$
...
$$Real\ Time = 7.2\text{ h} \times 0.80 \times 0.90 \approx 5.18\text{ ชั่วโมง}$$
...
$$Time = \frac{384\text{Wh}}{50\text{W}} = 7.68\text{ ชั่วโมง}$$
...
$$Real\ Time \approx 7.68 \times 0.80 \times 0.90 \approx 5.5\text{ ชั่วโมง}$$
...
แบตเตอรี่ Li-Po 6S 22.2V 5200mAh (65C) พร้อมสายไฟ XT90 และ Balance Plug
```
...
$$Time = \frac{115.4\text{Wh}}{50\text{W}} = 2.3\text{ ชั่วโมง}$$

$$Real\ Time \approx 2.3 \times 0.70 \approx 1.6\text{ ชั่วโมง}$$
...
$$Time = \frac{17.8\text{Wh}}{5\text{W}} \times 0.85 \times 0.90 \approx 2.72\text{ ชั่วโมง}$$
