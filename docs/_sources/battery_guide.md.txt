...
หากคุณไม่มีเวลาอ่านทั้งหมด นี่คือ **4 กฎเหล็ก** ของการใช้แบตเตอรี่ในห้องปฏิบัติการ RTL:

1.  **Stop at 20%:** ห้ามใช้แบตเตอรี่จนหมดเกลี้ยง! หากหุ่นยนต์เริ่มวิ่งช้าหรือมีเสียงเตือนจาก Li-Po Checker ให้หยุดและนำมาชาร์จทันที (แบต Li-Po พังทันทีถ้าแรงดันเซลล์ใดเซลล์นึงต่ำกว่า 3.0V)
2.  **Unplug After Use:** เมื่อเลิกใช้งานหุ่นยนต์ **ต้องถอดสายขั้วแบตเตอรี่ออกเสมอ** ห้ามเสียบคาไว้ เพราะวงจรจะกินไฟจนแบตพัง
3.  **Balance Charge Only:** เวลาชาร์จแบตเตอรี่แพค (ที่มีหลายเซลล์และมีสาย Balance) ต้องเสียบ **สาย Balance (หัวขาว)** ทุกครั้ง และเลือกโหมด **BALANCE** ที่เครื่องชาร์จเสมอ
4.  **Storage Mode:** หากจะไม่ใช้งานนานเกิน 3 วัน ต้องนำแบตเตอรี่มาชาร์จ/ดิสชาร์จให้อยู่ในโหมด **STORAGE** (3.8V หรือ 3.3V ดูที่หัวข้อแยกของแบตเตอรี่แต่ละชนิด) ห้ามเก็บตอนเต็มหรือหมด
:::
...
## 8. Troubleshooting (ปัญหาที่พบบ่อยและวิธีแก้)

หากใช้งานแบตเตอรี่หรือเครื่องชาร์จแล้วติดขัด ให้ลองตรวจสอบตามอาการดังนี้:

**1. เครื่องชาร์จฟ้อง "CONNECTION BREAK"**
* **อาการ:** กด Start แล้วเครื่องร้องเตือนทันที
* **สาเหตุ:** สายไฟขาดใน, เสียบสายไม่แน่น, หรือลืมเสียบสายหลัก (Main Lead)
* **Action:** ขยับขั้ว XT60 ให้แน่น หรือลองเปลี่ยนสายชาร์จใหม่

**2. เครื่องชาร์จฟ้อง "CELL ERROR" หรือ "VOLTAGE ERROR"**
* **อาการ:** ชาร์จไม่เข้า วัดแรงดันไม่ได้
* **สาเหตุ:** ลืมเสียบสาย Balance, สาย Balance ขาด, หรือมีเซลล์ใดเซลล์หนึ่งตาย (0V)
* **Action:** เช็คสายแพสีขาวว่าเสียบถูกช่องและแน่นหรือไม่ หากเสียบแน่นแล้วยังขึ้น แสดงว่าแบตเสีย (ห้ามใช้งานต่อ)

**3. ชาร์จแป๊บเดียวเต็ม แต่ใช้งานได้นิดเดียวหมด (False Peak)**
* **อาการ:** หน้าจอขึ้น FULL เร็วผิดปกติ (เช่นภายใน 5 นาที) แต่เอาไปวิ่งได้แค่ 1 นาที
* **สาเหตุ:** แบตเตอรี่เสื่อมสภาพ (ค่าความต้านทานภายในสูง)
* **Action:** ลอง Discharge และ Charge ใหม่ 1 รอบ ถ้าอาการไม่หาย ให้คัดแยกเป็นแบตเสื่อม (เขียนป้ายแปะไว้)

**4. เครื่องชาร์จร้อนจัด หรือมีเสียงพัดลมดังผิดปกติ**
* **สาเหตุ:** ตั้งกระแสชาร์จ (Amp) สูงเกินไป
* **Action:** ลดกระแสชาร์จลง (เช่นจาก 5A เหลือ 2A) เพื่อถนอมเครื่องชาร์จ

**5. แบตเตอรี่บวม (Puffing)**
* **สาเหตุ:** เกิดก๊าซภายในเนื่องจากความร้อนสูง, การใช้งานหนักเกิน (Over-discharge), หรือเก็บรักษาผิดวิธี
* **Action:** **ห้ามเจาะและห้ามชาร์จต่อเด็ดขาด** ให้ทำลายทิ้งด้วยการแช่น้ำเกลือทันที

**6. Li-Po Checker ร้องเตือนทั้งที่เพิ่งชาร์จมา (Voltage Sag)**
* **สาเหตุ:** ตั้งค่าเตือน (Alarm) สูงเกินไป ทำให้พอดึงกระแสไฟแล้วแรงดันตกจนถึงจุดเตือน
* **Action:** ปรับค่าเตือนลงมาที่ **3.40V - 3.50V** (กดปุ่มเล็กๆ ระหว่างลำโพงเพื่อตั้งค่า)